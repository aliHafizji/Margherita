...
CREATE TABLE list(id SERIAL PRIMARY KEY NOT NULL, user_id uuid references USERS(id), title TEXT NOT NULL, created_at TIMESTAMPTZ NOT NULL, archived_at TIMESTAMPTZ, updated_at TIMESTAMPTZ, active_completed_task_count INT, active_task_count INT, active_uncompleted_task_count INT, archived_task_count INT, archived_uncompleted_task_count INT);
